...
# Compresion utilizando método especificado
./tp1 -i entrada8.mp4 -o salida8.mp4 -m normal
./tp1 -i entrada8.mp4 -o salida8.mp4 -m list
./tp1 -i entrada8.mp4 -o salida8.mp4 -m tree
...
# Compresion utilizando método especificado
./tp1 --input entrada8.mp4 --output salida8.mp4 --method normal
./tp1 --input entrada8.mp4 --output salida8.mp4 --method list
./tp1 --input entrada8.mp4 --output salida8.mp4 --method tree
