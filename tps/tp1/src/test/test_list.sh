...
# Entrada vacia
touch entrada1.txt
./tp1 -i entrada1.txt -o salida1.txt -m list
cat salida1.txt
...
# Entrada thisisthe
cat entrada2.txt
./tp1 < entrada2.txt -m list
./tp1 -p compress < entrada2.txt -o salida2.txt -m list
...
cat entrada3.txt
./tp1 < entrada3.txt -m list
./tp1 -p compress < entrada3.txt -o salida3.txt -m list
...
# usando metodo list
stat -c %s entrada9
./tp1 -i entrada9 -o salida9 -p compress -m list
...
cat salida8
./tp1 -i salida8 -o vuelta8 -p decompress -m list

echo -e "\n"

# Compresion y decompresión de un archivo 'docx' y 'pdf'
./tp1 -i entrada6.docx -o salida6.docx -p compress -m list
./tp1 -i salida6.docx -o vuelta6.docx -p decompress
diff -s entrada6.docx vuelta6.docx

./tp1 -i entrada7.pdf -o salida7.pdf -m list
...
# Entrada vacia
touch entrada1.txt
./tp1 --input entrada1.txt --output salida1.txt --method list
cat salida1.txt
...
# Entrada thisisthe
cat entrada2.txt
./tp1 < entrada2.txt --method list
./tp1 --process compress < entrada2.txt --output salida2.txt --method list
...
# Compresion, decompresion y diferencia entre archivos
cat entrada3.txt
./tp1 < entrada3.txt --method list
./tp1 --process compress < entrada3.txt --output salida3.txt --method list
...
# usando metodo list
stat -c %s entrada9
./tp1 --input entrada9 --output salida9 --process compress --method list
...
# Descompresion de archivo con formato correcto, pero con índices fuera de rango
cat salida8
./tp1 --input salida8 --output vuelta8 --process decompress --method list

echo -e "\n"


# Compresion y decompresión de un archivo 'docx' y 'pdf'
./tp1 --input entrada6.docx --output salida6.docx --process compress --method list
./tp1 --input salida6.docx --output vuelta6.docx --process decompress
diff -s entrada6.docx vuelta6.docx

./tp1 --input entrada7.pdf --output salida7.pdf --method list
